# 以TypeScript的构建的NodeJS入门工程


[https://github.com/Microsoft/TypeScript-Node-Starter#typescript-node-starter](https://github.com/Microsoft/TypeScript-Node-Starter#typescript-node-starter)
...
# 在我们的电脑上，因为我的data/db目录设置在自己的自定义目录：
mongod --dbpath /usr/local/mongodb-4.2.3/data/db
```
...
In this section, I'll walk you through how to deploy this app to Azure App Service using the extensions available in VS Code 
because I think it is the easiest and fastest way to get started, as well as the most friendly workflow from a developer's perspective.
部署Node应用程序的方法有很多，通常，部署过程没有任何变化，因为您使用的是TypeScript。
在本节中，我将向您逐步介绍如何使用VS Code中提供的扩展程序将此应用程序部署到Azure App Service，因为我认为这是上手最简单，最快的方法，也是开发人员最友好的工作流程
